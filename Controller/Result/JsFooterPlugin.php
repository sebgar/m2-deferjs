<?php
namespace Sga\DeferJs\Controller\Result;
...
class JsFooterPlugin
{
    ...
    const EXCLUDE_FLAG = 'data-move="false"';
    ...
    private function extractScriptTags(&$content): string
    {
        ...
        while ($scriptOpenPos !== false) {
            ...
            $isExcludeFlag = strpos($script, self::EXCLUDE_FLAG) !== false;

            if ($isXMagentoTemplate || $isExcludeFlag) {
